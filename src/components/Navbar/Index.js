...
const navData = [
  { id: 1, name: "home", url: "/" },
  {
    ...
    name: "destinations",
    cat: [
      { id: 1, name: "Jammu & Kashmir", url: "/jammu-kashmir" },
      { id: 2, name: "Uttarakhand", url: "/uttarakhand" },
      { id: 3, name: "Himachal Pradesh", url: "/himachal-pradesh" },
      { id: 4, name: "Goa", url: "/goa" },
      { id: 5, name: "Rajasthan", url: "/rajasthan" },
    ],
  },
  {
    id: 3,
    name: "activities",
    cat: [
      { id: 1, name: "Adventure and Trekking", url: "/adventure and trekking" },
      {
        id: 2,
        name: "Safari and Natural Parks",
        url: "/safari and natural parks",
      },
      { id: 3, name: "Sea and Beaches", url: "/sea and beaches" },
      {
        id: 4,
      ...
      { id: 6, name: "Romance and Honeymoon", url: "/romance and honeymoon" },
      { id: 7, name: "Weekend Escapes", url: "/weekend escapes" },
    ],
  },
